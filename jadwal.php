  ...
  <body class="bg-awal">
    ...
    <div class="pt-5 mt-5 bg-awal w-100 d-flex justify-content-center align-items-center" style="height: 30vh">
      <div class="content text-md-center text-start mx-4 mx-md-0" data-aos="zoom-in" data-aos-duration="1300">
        <h1 class="fs-60 text-info font-payback">Jadwal</h1>
      </div>
    </div>
    <!--  judul end -->
      ...
      <div class="row">
        <div class="col-md-2 bg-awal h-100">
          <ul class="nav flex-column mt-2 ms-2">
            ...
            <li class="nav-item">
              <a class="nav-link text-info border-bottom border-secondary my-3" href="jadwal.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-event-fill me-2 text-info" viewBox="0 0 16 16">
                  <path
          ...
          <div class="mt-3">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body text-start">
                        <div class="form-floating mb-3">
                          <select class="form-select border border-info border-3" id="hari" aria-label="Floating label select example" name="hari" required>
                        ...
                        <div class="form-floating mb-3">
                          <select class="form-select border border-info border-3" id="id_pelatih" aria-label="Floating label select example" name="id_pelatih" required>
                            ...
                            <option value="<?= $pelatih2['id_pelatih'];?>"><?= $pelatih2['nama_pelatih'];?></option>
                            <?php endforeach;?>
                          </select>
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php $i = 1;?>
                  <?php foreach($jadwal as $jadwal2):?>
                  <tr>
                    <td class="text-center"><?= $i;?></td>
                    <td><?= $jadwal2["hari"];?></td>
                    <td>
                        <?php 
                        $ambil = $jadwal2["id_pelatih"];
                        $pelat = query("SELECT * FROM pelatih WHERE id_pelatih='$ambil'")[0];
                        ?>
                        <?= $pelat['nama_pelatih'];?>
                    </td>
                    <td>
                      <a href="ubahjadwal.php?id_jadwal=<?= $jadwal2["id_jadwal"]?>" class="text-decoration-none mb-3 btn btn-warning" data-bs-toggle="tooltip" title="Edit">
                      ...
                      <a href="hapusjadwal.php?id_jadwal=<?= $jadwal2["id_jadwal"]?>" class="text-decoration-none mb-3 btn btn-danger" onclick="return confirm('Anda yakin data ingin dihapus ?');" data-bs-toggle="tooltip" title="Hapus">
