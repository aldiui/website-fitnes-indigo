  ...
  <body>
    ...
    <div class="pt-5 mt-5 bg-awal w-100 d-flex justify-content-center align-items-center" style="height: 30vh">
      <div class="content text-md-center text-start mx-4 mx-md-0" data-aos="zoom-in" data-aos-duration="1300">
        <h1 class="fs-60 text-info font-payback">Konsultasi</h1>
      </div>
    </div>
    <!--  judul end -->
      ...
      <div class="row">
        <div class="col-md-2 bg-awal h-100">
          <ul class="nav flex-column mt-2 ms-2">
            ...
            <li class="nav-item">
              <a class="nav-link text-info border-bottom border-secondary my-3" href="komentar.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-left-fill text-info me-2" viewBox="0 0 16 16">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $komen["pesan"];?></td>
                    <td>
                      <a href="hapuskomentar.php?id_komen=<?= $komen["id_komen"];?>" class="text-decoration-none btn btn-danger" onclick="return confirm('Anda yakin data ingin dihapus ?');" data-bs-toggle="tooltip" title="Hapus">
