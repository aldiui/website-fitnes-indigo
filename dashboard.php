...
$admin = query("SELECT * FROM user WHERE id_user = '$ambil'");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body class="bg-awal">
    ...
    <div class="pt-5 mt-5 bg-awal w-100 d-flex justify-content-center align-items-center" style="height: 30vh">
      <div class="content text-md-center text-start mx-4 mx-md-0" data-aos="zoom-in" data-aos-duration="1300">
        <h1 class="fs-60 text-info font-payback">DASHBOARD</h1>
      </div>
    </div>
    <!--  judul end -->
      ...
      <div class="row">
        <div class="col-md-2 bg-awal h-100">
          <ul class="nav flex-column mt-2 ms-2">
            <li class="nav-item">
              <a class="nav-link text-info border-bottom border-secondary my-3 active" aria-current="page" href="dashboard.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-speedometer me-2 text-info" viewBox="0 0 16 16">
                  <path
                  ...
                  <div class="my-3 mx-1">
                    <div class="row justify-content-center">
                      <div class="col-lg-4 col-6 mb-3">
                        <div class="card p-2 rounded-3 bg-success bg-opacity-75 text-center text-white">
                          <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-person-fill my-2 text-white mx-auto" viewBox="0 0 16 16">
                            <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                          </svg>
                          <?php
                      ...
                      <div class="col-lg-4 col-6 mb-3">
                        <div class="card p-2 rounded-3 bg-primary bg-opacity-75 text-center text-white">
                          <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-collection-fill my-2 text-white mx-auto" viewBox="0 0 16 16">
                            <path
                              d="M0 13a1.5 1.5 0 0 0 1.5 1.5h13A1.5 1.5 0 0 0 16 13V6a1.5 1.5 0 0 0-1.5-1.5h-13A1.5 1.5 0 0 0 0 6v7zM2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3zm2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1z"
                            />
                          </svg>
                          <?php
                          $result2 = mysqli_query($conn, "SELECT * FROM kelas");
                          $data2= array();
                          while(($row =mysqli_fetch_array($result2)) != null){
                            $data2[] = $row;
                          }
                          $count2 = count($data2);
                          ?>
                      ...
                      <div class="col-lg-4 col-6 mb-3">
                        <div class="card p-2 rounded-3 bg-warning bg-opacity-75 text-center text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-people-fill my-2 text-white mx-auto" viewBox="0 0 16 16">
                          <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                          <path fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z" />
                          <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z" />
                        </svg>
                          <?php
                          $result3 = mysqli_query($conn, "SELECT * FROM pelatih");
                          $data3= array();
                          while(($row =mysqli_fetch_array($result3)) != null){
                            $data3[] = $row;
                          }
                          $count3 = count($data3) - 2;
                          ?>
                          <h1><?= $count3;?> Pelatih</h1>
                        </div>
                      </div>
                    </div>
                  </div>
