...
<html lang="en">
  ...
  <body class="bg-awal">
    ...
    <!--  judul end -->
    <div class="conatainer-fluid p-0 m-0">
      <div class="row">
          ...
          <div class="mt-3">
                  ...
                  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                      ...
                      <div class="modal-body text-start">
                        ...
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control border border-info border-3" name="nama_kelas" id="nama_kelas" placeholder="nama_kelas" autocomplete="off" required />
                          <label for="nama_kelas">Nama kelas</label>
                        </div>
                        <div class="form-floating mb-3">
                          <textarea class="form-control border border-info border-3" name="deskripsi" placeholder="deskripsi" id="deskripsi" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="form-floating mb-3">
                          <input type="number" class="form-control border border-info border-3" name="harga" id="harga" placeholder="harga" autocomplete="off" required />
                          <label for="harga">Harga</label>
                        </div>
                        <div class="form-floating mb-3">
                          <input type="number" class="form-control border border-info border-3" name="stok" id="stok" placeholder="stok" autocomplete="off" required />
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php $i = 1;?>
                  <?php foreach($kelas as $kelas2):?>
                  <tr>
                    <td class="text-center"><?= $i;?></td>
                    <td>
                        <?php 
                        $ambil1 = $kelas2["id_kegiatan"];
                        $pelat1 = query("SELECT * FROM kegiatan WHERE id_kegiatan = $ambil1")[0];
                        ?>
                        <?= $pelat1['nama_kegiatan'];?>
                    </td>
                    <td><?= $kelas2["nama_kelas"];?></td>
                    <td>
                        <?php 
                        $ambil = $kelas2["id_pelatih"];
                        $pelat = query("SELECT * FROM pelatih WHERE id_pelatih = $ambil")[0];
                        ?>
                        <?= $pelat['nama_pelatih'];?>
                    </td>
                    <td>Rp. <?= $kelas2["harga"];?></td>
                    <td><?= $kelas2["jadwal"];?></td>
                    <td><?= $kelas2["stok"];?></td>
                    <td>
                      <a href="ubahkelas.php?id_kelas=<?= $kelas2["id_kelas"];?>" class="text-decoration-none mb-3 btn btn-warning" data-bs-toggle="tooltip" title="Edit">
                      ...
                      <a href="hapuskelas.php?id_kelas=<?= $kelas2["id_kelas"];?>" class="text-decoration-none mb-3 btn btn-danger" onclick="return confirm('Anda yakin data ingin dihapus ?');" data-bs-toggle="tooltip" title="Hapus">
