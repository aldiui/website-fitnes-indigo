    ...
    <div class="container-fluid p-0 m-0">
      <div class="row">
        <div class="col-md-2 bg-awal h-100">
            ...
            <li class="nav-item">
              <a class="nav-link text-info border-bottom border-secondary my-3" href="user.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill text-info me-2" viewBox="0 0 16 16">
          ...
          <div class="card p-2">
            <div class="row justify-content-center">
                <div class="col-lg-9 col-md-10">
                    <div class="my-3 mx-1">
                        <h3 class="font-bebas text-center mb-3">Edit User</h3>
                        <form action="" method="post">
                            <input type="hidden" name="id_user" value="<?= $user["id_user"];?>">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control border border-info border-3" name="username" id="username" placeholder="username" autocomplete="off" required value="<?= $user['username']?>">
                                <label for="username">Username</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control border border-info border-3" name="alamat" id="alamat" placeholder="alamat" autocomplete="off" required value="<?= $user['alamat']?>">
                                <label for="alamat">Alamat</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control border border-info border-3" name="nohp" id="nohp" placeholder="nohp" autocomplete="off" required value="<?= $user['nohp']?>">
                                <label for="nohp">No handphone</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control border border-info border-3" name="email" id="email" placeholder="email" autocomplete="off" required value="<?= $user['email']?>">
