  ...
  <body class="bg-awal">
    ...
    <div class="pt-5 mt-5 bg-awal w-100 d-flex justify-content-center align-items-center" style="height: 30vh">
      <div class="content text-md-center text-start mx-4 mx-md-0" data-aos="zoom-in" data-aos-duration="1300">
        <h1 class="fs-60 text-info font-payback">pelatih</h1>
      </div>
    </div>
    <!--  judul end -->
      ...
      <div class="row">
        <div class="col-md-2 bg-awal h-100">
          <ul class="nav flex-column mt-2 ms-2">
            ...
            <li class="nav-item">
              <a class="nav-link text-info border-bottom border-secondary my-3" href="pelatih.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill text-info me-2" viewBox="0 0 16 16">
            ...
            <li class="nav-item">
              <a class="nav-link text-white border-bottom border-secondary my-3" href="kelasog.php">
        ...
        <div class="col-md-10 p-4 bg-aneh">
          <div class="card p-2">
          <div class="mt-3">
              <button type="button" class="btn btn-success font-payback mb-3" data-bs-target="#tambahdata" data-bs-toggle="modal">+ Tambah Data</button>
              <!-- modal tambah data awal -->
              <form action="" method="post" enctype="multipart/form-data">
                <div class="modal fade" id="tambahdata" aria-hidden="true" aria-labelledby="tambahdataLabel2" tabindex="-1">
                  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title font-bebas h2" id="tambahdataLabel2">TAMBAH DATA</h5>
                        <button type="reset" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body text-start">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control border border-info border-3" name="nama_pelatih" id="nama_pelatih" placeholder="nama_pelatih" autocomplete="off" required />
                        ...
                        <div class="form-floating mb-3">
                          <select class="form-select border border-info border-3" id="skill" aria-label="Floating label select example" name="skill" required>
                            <?php foreach($skill as $skill2):?>
                        ...
                        <div class="mb-3 text-center">
                          ...
                          <input type="file" class="form-control border border-info border-3" name="gambar" id="gambar"  placeholder="alamat" autocomplete="off" required/>
                        </div>
                      </div>
                      <div class="modal-footer justify-content-center">
                        <button type="submit" class="btn btn-success font-payback" name="tambahdata">Simpan</button>
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php $i = 1;?>
                  <?php foreach($pelatih as $pelatih2):?>
                  <tr>
                    <td class="text-center"><?= $i;?></td>
                    <td><?= $pelatih2["nama_pelatih"];?></td>
                    <td>
                        <?php 
                        $ambil = $pelatih2["skill"];
                        $skill = query("SELECT * FROM kegiatan WHERE id_kegiatan = '$ambil'")[0];
                        ?>
                        <?= $skill['nama_kegiatan']?>
                    </td>
                    <td><?= $pelatih2["nohp"];?></td>
                    <td><?= $pelatih2["email"];?></td>
                    <td><?= $pelatih2["alamat"];?></td>
                    <td>
                      <a href="ubahpelatih.php?id_pelatih=<?= $pelatih2["id_pelatih"];?>" class="text-decoration-none mb-3 btn btn-warning" data-bs-toggle="tooltip" title="Edit">
                      ...
                      <a href="hapuspelatih.php?id_pelatih=<?= $pelatih2["id_pelatih"];?>" class="text-decoration-none mb-3 btn btn-danger" onclick="return confirm('Anda yakin data ingin dihapus ?');" data-bs-toggle="tooltip" title="Hapus">
