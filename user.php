              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user2["level"];?></td>
                    <td>
                      <a href="ubahuser.php?id_user=<?= $user2["id_user"];?>" class="text-decoration-none mb-3 btn btn-warning" data-bs-toggle="tooltip" title="Edit">
                      ...
                      <a href="hapususer.php?id_user=<?= $user2["id_user"];?>" class="text-decoration-none mb-3 btn btn-danger" onclick="return confirm('Anda yakin data ingin dihapus ?');" data-bs-toggle="tooltip" title="Hapus">
