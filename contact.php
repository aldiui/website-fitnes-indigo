...
$pembayaran = query("SELECT * FROM transaksi WHERE id_user = '$ambil'");
?>
  ...
  <body>
          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link text-white mx-lg-4 my-2 my-lg-0 font-bebas fs-5" href="contact.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle text-info" viewBox="0 0 16 16" data-bs-toggle="tooltip" title="Akun">
    ...
    <div class="pt-5 mt-5 bg-awal w-100 d-flex justify-content-center align-items-center" style="height: 30vh">
      <div class="content text-md-center text-start mx-4 mx-md-0" data-aos="zoom-in" data-aos-duration="1300">
        <h1 class="fs-60 text-info font-payback">User</h1>
      </div>
    </div>
    <!--  judul end -->
    <!-- comment start -->
    <section id="comment" class="bg-aneh py-5">
      <div class="container py-5">
        <div class="row text-center" data-aos="zoom-in" data-aos-duration="1300">
          <div class="col mb-3">
            <h1 class="font-payback text-info">Data Diri</h1>
          </div>
        </div>
        <div class="row justify-content-center" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
          <div class="col-lg-7 col-md-10 mb-3">
            <div class="form-floating mb-3">
              <input type="text" disabled="active" class="form-control border border-info border-3" name="nama" id="nama" placeholder="nama" autocomplete="off" required value="<?= $user2['nama']?>">
              <label for="nama">Nama Lengkap</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" disabled="active" class="form-control border border-info border-3" name="username" id="username" placeholder="username" autocomplete="off" required value="<?= $user2['username']?>">
              <label for="username">Username</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" disabled="active" class="form-control border border-info border-3" name="tempat" id="tempat" placeholder="tempat" autocomplete="off" required value="<?= $user2['tempat']?>">
              <label for="tempat">Tempat Lahir</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" disabled="active" class="form-control border border-info border-3" name=tl" id=tl" placeholder=tl" autocomplete="off" required value="<?= $user2['tl']?>">
              <label for=tl">Tanggal Lahir</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" disabled="active" class="form-control border border-info border-3" name=jk" id=jk" placeholder=jk" autocomplete="off" required value="<?= $user2['jk']?>">
              <label for=jk">Jenis Kelamin</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" disabled="active" class="form-control border border-info border-3" name="alamat" id="alamat" placeholder="alamat" autocomplete="off" required value="<?= $user2['alamat']?>">
              <label for="alamat">Alamat</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" disabled="active" class="form-control border border-info border-3" name="nohp" id="nohp" placeholder="nohp" autocomplete="off" required value="<?= $user2['nohp']?>">
              <label for="nohp">No handphone</label>
            </div>
            <div class="form-floating mb-3">
              <input type="email" disabled="active" class="form-control border border-info border-3" name="email" id="email" placeholder="email" autocomplete="off" required value="<?= $user2['email']?>">
    ...
    <!-- comment end -->
    <!-- riwayat kelas start -->
    <section id="riwayat" class="bg-aneh py-5">
      <div class="container py-5">
        <div class="row text-center" data-aos="zoom-in" data-aos-duration="1300">
          <div class="col mb-3">
            <h1 class="font-payback text-info">Riwayat Pembayaran</h1>
          </div>
        </div>
        <div class="row justify-content-center" data-aos="zoom-in" data-aos-duration="1300"r>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php 
                      $nk=$bayar['id_kelas'];
                      $namakelas=query("SELECT * FROM kelas WHERE id_kelas='$nk'")[0];
                      ?>
                      <?= $namakelas['nama_kelas'];?>
                    </td>
                    <td><?= $namakelas['jadwal'];?></td>
