...
$kegiatan = query("SELECT * FROM kegiatan WHERE id_kegiatan=$id_kegiatan")[0];
          ...
          <div class="card p-2">
            <div class="row justify-content-center">
                <div class="col-lg-9 col-md-10">
                    <div class="my-3 mx-1">
                        <h3 class="font-bebas text-center mb-3">Edit Kegiatan</h3>
                        <form action="" method="post">
                          <input type="hidden" name="id_kegiatan" value="<?= $kegiatan["id_kegiatan"];?>">
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control border border-info border-3" name="nama_kegiatan" id="nama_kegiatan" placeholder="nama_kegiatan" autocomplete="off"  value="<?= $kegiatan["nama_kegiatan"];?>" required />
