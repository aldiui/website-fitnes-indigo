  ...
  <body class="bg-awal">
    ...
    <div class="pt-5 mt-5 bg-awal w-100 d-flex justify-content-center align-items-center" style="height: 30vh">
      <div class="content text-md-center text-start mx-4 mx-md-0" data-aos="zoom-in" data-aos-duration="1300">
        <h1 class="fs-60 text-info font-payback">KEGIATAN</h1>
      </div>
    </div>
    <!--  judul end -->
      ...
      <div class="row">
        <div class="col-md-2 bg-awal h-100">
          <ul class="nav flex-column mt-2 ms-2">
            ...
            <li class="nav-item">
              <a class="nav-link text-info border-bottom border-secondary my-3" href="kegiatan.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bullseye text-info me-2" viewBox="0 0 16 16">
          ...
          <div class="mt-3">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body text-start">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control border border-info border-3" name="nama_kegiatan" id="nama_kegiatan" placeholder="nama_kegiatan" autocomplete="off" required />
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php $i = 1;?>
                  <?php foreach($kegiatan as $kegiatan2):?>
                  <tr>
                    <td class="text-center"><?= $i;?></td>
                    <td><?= $kegiatan2["nama_kegiatan"];?></td>
                    <td>
                      <a href="ubahkegiatan.php?id_kegiatan=<?= $kegiatan2["id_kegiatan"];?>" class="text-decoration-none mb-3 btn btn-warning" data-bs-toggle="tooltip" title="Edit">
                      ...
                      <a href="hapuskegiatan.php?id_kegiatan=<?= $kegiatan2["id_kegiatan"];?>" class="text-decoration-none mb-3 btn btn-danger" onclick="return confirm('Anda yakin data ingin dihapus ?');" data-bs-toggle="tooltip" title="Hapus">
