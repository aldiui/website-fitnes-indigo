  ...
  <body class="bg-awal">
    ...
    <div class="pt-5 mt-5 bg-awal w-100 d-flex justify-content-center align-items-center" style="height: 30vh">
      <div class="content text-md-center text-start mx-4 mx-md-0" data-aos="zoom-in" data-aos-duration="1300">
        <h1 class="fs-60 text-info font-payback">DATA DIRI ADMIN</h1>
      </div>
    </div>
    <!--  judul end -->
    <div class="container-fluid p-0 m-0">
      <div class="row">
        ...
        <div class="col-md-10 p-4 bg-aneh">
          <div class="card p-2">
            <div class="row justify-content-center my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
            <div class="col-lg-7 col-md-10 mb-3">
                <!-- <div class="my-4 d-flex justify-content-center">
                <div class="card p-2 shadow-lg">
                    <img src="img/<?= $user2["gambar"];?>" alt="" width="250" height="250">
                </div>
                </div> -->
