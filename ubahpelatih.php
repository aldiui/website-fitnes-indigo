...
$pelatih = query("SELECT * FROM pelatih WHERE id_pelatih=$id_pelatih")[0];
          ...
          <div class="card p-2">
            <div class="row justify-content-center">
                <div class="col-lg-9 col-md-10">
                    <div class="my-3 mx-1">
                        <h3 class="font-bebas text-center mb-3">Edit pelatih</h3>
                        <form action="" method="post" enctype="multipart/form-data">
                          <input type="hidden" name="id_pelatih" value="<?= $pelatih["id_pelatih"];?>">
                          <input type="hidden" name="gambarlama" value="<?= $pelatih["gambar"];?>">
                          <div class="my-4 d-flex justify-content-center">
                            <div class="card p-2 shadow-lg">
                              <img src="img/<?= $pelatih["gambar"];?>" alt="" width="250" height="250">
                            </div>
                          </div>
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control border border-info border-3" name="nama_pelatih" id="nama_pelatih" placeholder="nama_pelatih" autocomplete="off" required value="<?= $pelatih["nama_pelatih"];?>">
                          ...
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control border border-info border-3" name="nohp" id="nohp" placeholder="nohp" autocomplete="off" required value="<?= $pelatih["nohp"];?>"/>
                            <label for="nohp">No Handphone</label>
                          </div>
                          <div class="form-floating mb-3">
                            <input type="email" class="form-control border border-info border-3" name="email" id="email" placeholder="email" autocomplete="off" required value="<?= $pelatih["email"];?>"/>
                          ...
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control border border-info border-3" name="alamat" id="alamat" placeholder="alamat" autocomplete="off" required value="<?= $pelatih["alamat"];?>" />
